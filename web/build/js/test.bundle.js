...
/***/ function(module, exports, __webpack_require__) {
	...
	var _testServerIO = __webpack_require__(1);
	
	var _testServerIO2 = _interopRequireDefault(_testServerIO);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ServerIO = __webpack_require__(2);
	...
	describe('ServerIO', function () {
	    ...
	    it('get charity', function (done) {
	        _ServerIO2.default.getCharity('solar-aid').then(function (results) {
	            var charity = results.cargo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sjtest = __webpack_require__(6);
	...
	**/
	...
	ServerIO.load = function (url, params) {
		(0, _sjtest.assertMatch)(url, String);
		...
		defrd = defrd.then(ServerIO.handleMessages).fail(function (response) {
			console.error('fail', url, params, response);
			ServerIO.ActionMan.perform({
				verb: _C2.default.action.notify,
				messages: [{
					type: 'error',
	...
	ServerIO.handleMessages = function (response) {
		...
		ServerIO.ActionMan.perform({ verb: _C2.default.action.notify, messages: newMessages });
		return response;
	};
